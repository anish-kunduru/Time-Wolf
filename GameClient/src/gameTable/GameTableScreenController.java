...
public class GameTableScreenController implements ControlledScreen
{
   ...
   public void initialize() throws SQLException
   {
      ...
      playerHandImages = new ImageView[] { playerHandOne, playerHandTwoo, playerHandThree, playerHandFour, playerHandFive, playerHandSix, playerHandSeven,
   ...
   /**
    * Method called to initialize the game play area when the screen is first loaded. Takes care of both effects and populating fields.
    * 
    * @param playerHand
    * @param gameTableHand
    * @param playerNames
   ...
   /**
    * Helper method to recall actions. Called after an action has taken place to update the actions.
    */
   private void update()
   {
      // Handles ending the turn on button clicked
   ...
   /**
    * This method determines the action associated with the given Action object and passes it into the appropriate method.
    * 
    * @param a
    */
